...
4. **Create Sentinel File**
   ...
   - This signals the release workflow that changelog work is done (either new entry written or existing entry confirmed)
   
5. **Wait for Script Completion**
   - Do NOT run the release workflow yourself
   - The user will run it
   - Script will handle all remaining steps

### Release Workflow Automation (release.md)
...
- `release.md` is a workflow document, NOT part of the integration
- Only the user can run the release workflow (agent cannot initiate it autonomously)

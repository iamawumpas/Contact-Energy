...
### Phase 3 (v1.6.x) - ApexCharts Integration
Format data for ApexCharts card consumption.

**New Files:**
- `wiki/ApexCharts-Usage.md` - Documentation with examples

**Features:**
- Data transformer for ApexCharts `data_generator`
- Separate paid/free series

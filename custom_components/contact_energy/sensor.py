...
async def async_setup_entry(
    ...
    entities = [
        # Usage Data Sensor (Phase 2 / v1.5.0)
        ContactEnergyUsageSensor(
            coordinator, config_entry, entity_name, contract_id
        ),
...
class ContactEnergyUsageSensor(CoordinatorEntity, SensorEntity):
    ...
    all cached usage data (hourly, daily, monthly) ready for graphing with
    ApexCharts or other visualization tools.

    Phase 2 (v1.5.0) implementation.

...
- **Agent does NOT create changelog entries autonomously**
- Changelog is only created/modified when release.sh instructs the agent
- User controls when and what goes into the changelog

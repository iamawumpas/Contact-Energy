...
- **API Usage:** Reference .API_instructions.md for Contact Energy API
...
**Authorization Trigger:** User must explicitly say "Release v[X.Y.Z]" or "Please create a release for..."
...
|--------|------------------------|---------|
| Bug fixes / refactoring | ❌ No | Just do it |
...
| Writing changelog | ✅ Yes | Only when user requests or release.sh instructs |
| Updating wiki | ✅ Yes | Ask before proceeding |
| Git commits | ❌ No | Commit code changes directly |